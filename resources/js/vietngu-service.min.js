...
(function(){var a=function(a,f,e,c){var d={},g={url:atob(airtable.url.vietngu),key:atob(airtable.key),token:airtable.token,tables:{student:{fields:["oen","name","lang","grade","active"]},reportcard:{fields:"oen lang absent skill oral reading writing signature".split(" ")}}};f.defaults.headers.common.Authorization="Bearer "+g.token;d.loadStudents=function(b){var c=a.defer();e.getData("student",g).then(function(a){a=a.reduce(function(a,c){c.active&&c.lang===b&&a.push(c);return a},[]);e.sortByLocale(a,
